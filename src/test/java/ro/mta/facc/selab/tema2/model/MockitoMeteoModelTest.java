...
public class MockitoMeteoModelTest {
    ...
    @Before
    public void setUp() {
        BufferedReader i = mock(BufferedReader.class);
        try {
            when(i.readLine()).thenReturn("RO").thenReturn("Slatina").thenReturn("RO").thenReturn("Slatina");


            model = new MeteoModel(i.readLine(),i.readLine());
